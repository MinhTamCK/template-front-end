...
var Slider = {
    init: function() {
        particlesJS.load('stu-particles', '../js/data/particles.json', this.hideLoading());
    },
...
var DrawRaphael = {
    ...
    diagram: function() {
        var r = Raphael('my-skills', 600, 500),
            rad = 73,
            defaultText = 'Skills',
            speed = 250;
        ...
        r.customAttributes.arc = function(value, color, rad) {
            var v = 3.6 * value,
                ...
                random = DrawRaphael.random(91, 240),
        ...
        $('.params').find('.param').each(function(i) {
            var t = $(this),
